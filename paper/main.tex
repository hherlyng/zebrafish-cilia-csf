...
\author[FIX ME]{Inyoung Jeong} % OK?
...
\affil[2]{\fixme{@Nathalie is this correct?: Department of Clinical and Molecular Medicine,
Norwegian University of Science and Technology, Trondheim, Norway\\
Same affiliation for Inyoung?}}
...
We seek to model the compartimentalized and pulsatile CSF flow observed \emph{in vivo}~(\Cref{fig:fig1}\fixme{b--c}).
...
(\Cref{fig:fig2}a). In particular, we consider the spread of
...
in 6 regions of interest (ROIs) (\Cref{fig:fig2}a).
