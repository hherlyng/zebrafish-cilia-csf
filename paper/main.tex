...
\begin{figure}%[H]
    ...
    as function of time for diffusion coefficients $D_1$, $D_2$ and $D_3$, respectively. 
...
the final time \fixme{(0.72, 0.82, 0.56, 0.35 and X in ROIs 2--6, respectively)}
...
model compared to the experimental data in \Cref{fig:fig4},
...
(in general the length is between 10--15 \textmu m~\cite{Afzelius2004CiliaRelatedDiseases}),
...
(recall that our model exhibits a maximum of 27.9 \textmu m/s).
