...
force~(\Cref{fig:fig5}b). The magnitude of the force contributions are thus
...
exhibit changes in the dynamics of $\cbar$ (\Cref{fig:fig5}c).
...
mean concentration $\cbar$ with time (\Cref{fig:fig5}c).
