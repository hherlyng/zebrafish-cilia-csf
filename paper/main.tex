...
\affil[1]{Department for Numerical Analysis and Scientific Computing, Simula Research Laboratory, Oslo, Norway} % Kristian Augusts gate 23, 0164
...
than we assumed. This would reduce the diffusion coefficient (cf.~\Cref{eq:D_stokes_einstein}),
...
% The geometry they studied resembles a pipe,
% probably offering more flow resistance than the open geometry considered in our work,
% which may be why they needed a larger force density to accurately represent
% experimental results. In any case,
...
local refinement functionality in DOLFINx~\cite{dolfinx2023preprint}. The standard mesh
