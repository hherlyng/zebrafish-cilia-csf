...
\begin{figure}[H]
    ...
    and the total force applied. In each region, the force $F_{\mathrm{original}}$ 
    applied on the original mesh is the baseline of 100\%,
    to which the force $F_i$ of the other mesh versions are compared, where $i$ denotes
    the case. The bars for the four shrunk scenarios thus
