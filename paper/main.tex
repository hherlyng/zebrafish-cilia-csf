...
\keywords{cerebrospinal fluid, brain ventricles, transport, finite element method}
...
similar to the other molecules.
...
To assess the assumption that the CSF flow is governed by the Stokes equations,
...
\subsection{Impact of cilia motility and ventricular morphology}
...
parameters in our models. First, we paralyzed cilia in specific regions of
...
Next, we modified the ventricular geometry and identified the impact on transport.
...
\medskip
\textbf{Declaration of No Competing Interest} \par
\fixme{TO DO}.
