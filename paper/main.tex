...
processes, including the flow of cerebrospinal fluid (CSF). CSF is a
clear liquid produced by the choroid plexus and the fluid flows
through the ventricular system and subarachnoid space.  By
transporting growth factors, nutrients, neurotransmitters and
metabolites and removing waste products, CSF regulates brain
development and homeostasis.  Disturbance of the CSF circulation can
lead to brain disorders, such as hydrocephalus where accumulation of
CSF often requires emergency surgical treatment.
...
indicating that the cilia play a crucial role for healthy brain functioning.
...
and the combination of the above three modifications (\Crefpanels{fig:fig6}{a}). In these
...
(\Crefpanels{fig:fig6}{c}, shrunk mid-hind scenario).
