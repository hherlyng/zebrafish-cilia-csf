...
provides mechanical support of the brain and the flow of CSF helps
...
of the brain ventricles. Despite the physiological importance of CSF flow,
...
flow and accompanying transport, such as pressure
...
in animal models and humans with deficient motile cilia~\cite{Afzelius2004Cilia-relatedDiseases,
...
framework together that can be applied to other
...
speeds ($\fixme{26.5}$ \textmu m/s) occur in the vicinity of the dorsal cilia
...
velocity magnitude peaks at $\fixme{4.8}$ \textmu m/s. CSF initially flows
...
rostrocaudal axis, reaching up to 28.0 \textmu m/s dorsally in the
...
%% 28.0 \textmu m/s, dorsally in the posterior part of the middle
...
as the maximum velocity magnitude drops from \fixme{27.7} \textmu m/s to \fixme{8.0} \textmu m/s.
...
impact and results in maximum speeds of \fixme{27.7} \textmu m/s or \fixme{27.2} \textmu m/s, respectively.
...
(recall that our model exhibits a maximum of 28.0 \textmu m/s).
...
$U_r = 28.0$ \textmu m/s (the maximum velocity magnitude)
